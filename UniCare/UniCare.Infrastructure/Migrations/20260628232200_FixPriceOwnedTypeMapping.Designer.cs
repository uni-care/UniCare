...
namespace UniCare.Infrastructure.Migrations
{
    ...
    [Migration("20260628232200_FixPriceOwnedTypeMapping")]
    partial class FixPriceOwnedTypeMapping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniCare.Domain.Aggregates.ItemAggregates.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UniCare.Domain.Aggregates.ItemAggregates.Item", b =>
                {
                    b.HasOne("UniCare.Domain.Aggregates.ItemAggregates.Category", "Category")
                        .WithMany("Items")
                    ...
                    b.OwnsOne("UniCare.Domain.VOs.Money", "Price", b1 =>
                        {
